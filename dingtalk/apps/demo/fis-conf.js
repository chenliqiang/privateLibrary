var user = "dingtalk/apps/dingtalk";
...
fis.match("components/**", {
    isMod: true,
    release: '/static/duliang/'+user+'/static/$0'
});
...
fis.match('::packager', {
    ...
    packTo: '/static/duliang/'+user+'/static/pkg/all.css' //css打成一个包
})
