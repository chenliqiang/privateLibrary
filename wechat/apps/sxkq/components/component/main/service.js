...
function getWater(p,c){
    $.post(prefix +"/duliang/1.1/wechat/meter/query",JSON.stringify(p), function (rep) {
        valid(rep,c)
    })
}
...
function wxPay1_2(p,c,e){
    $.post(prefix +"/duliang/1.1/wechat/jssdk1.2/wxpay",JSON.stringify(p), function (rep) {
        valid(rep,c, e)
    })
}
